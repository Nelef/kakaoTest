package com.uyjang.kakaotest.view.compose
...
import com.uyjang.kakaotest.view.ui.theme.LightBlue
import com.uyjang.kakaotest.view.ui.theme.LightRed
...
fun MarketDataRow(
    ...
    KakaoMarketBox(modifier = Modifier.fillMaxWidth()) {
        Row(
            Modifier
                .height(50.dp)
                .padding(8.dp),
